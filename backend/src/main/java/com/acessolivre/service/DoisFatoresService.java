...
public class DoisFatoresService {
    ...
    public boolean duasFatoresAtivadosPorEmail(String email) {
    ...
    @Transactional
    public ConfiguracaoDoisFatoresResponseDTO prepararConfiguracao(Long userId) {
        ...
        return ConfiguracaoDoisFatoresResponseDTO.builder()
            .qrCode(qrCode)
            .secretKey(secretKey)
            .issuer(ISSUER)
    ...
    public boolean validarCodigoRecuperacao(Usuario usuario, String codigo) {
        ...
        String codigoNormalizado = codigo.trim();
        Optional<CodigoRecuperacaoDoisFatores> codigoRecuperacao = twoFactorRecoveryCodeRepository
        ...
        CodigoRecuperacaoDoisFatores registro = codigoRecuperacao.get();
    ...
    private void salvarCodigosRecuperacao(Usuario usuario, List<String> recoveryCodes) {
        ...
        List<CodigoRecuperacaoDoisFatores> codigos = recoveryCodes.stream()
            .map(codigo -> CodigoRecuperacaoDoisFatores.builder()
                .usuario(usuario)
                .codigo(codigo)
