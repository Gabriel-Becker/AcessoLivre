...
public interface CodigoRecuperacaoDoisFatoresRepository extends JpaRepository<CodigoRecuperacaoDoisFatores, Long> {
     ...
     */
    List<CodigoRecuperacaoDoisFatores> findByUsuario_IdUsuario(Long idUsuario);
     ...
     */
    List<CodigoRecuperacaoDoisFatores> findByUsuario_IdUsuarioAndUtilizadoFalse(Long idUsuario);
     ...
     */
    List<CodigoRecuperacaoDoisFatores> findByUsuario_IdUsuarioAndUtilizadoFalseAndDataExpiracaoAfter(Long idUsuario, LocalDateTime now);
     ...
     */
    Optional<CodigoRecuperacaoDoisFatores> findByCodigoAndUsuario_IdUsuario(String codigo, Long idUsuario);
     ...
     */
    List<CodigoRecuperacaoDoisFatores> findByDataExpiracaoBefore(LocalDateTime now);
}
