...
public class ServicoJwt {
    ...
    public ServicoJwt(JwtEncoder encoder, JwtDecoder jwtDecoder, TokenRevogadoRepository tokenRevogadoRepository, UsuarioRepository usuarioRepository) {
    ...
    public boolean tokenEhValido(String token, UserDetails userDetails) {
