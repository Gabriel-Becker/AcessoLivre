...
import com.acessolivre.security.ServicoDetalhesUsuario;
import com.acessolivre.security.ServicoJwt;
import com.acessolivre.security.FiltroRespostaToken;
...
public class ConfiguracaoSeguranca {
    ...
    private final ServicoDetalhesUsuario customUserDetailsService;
    ...
    @Bean
    public FiltroRespostaToken tokenResponseFilter() {
        return new FiltroRespostaToken(jwtService, usuarioRepository);
    }
